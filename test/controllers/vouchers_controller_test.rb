...
class VouchersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create voucher" do
    assert_difference('Voucher.count') do
      post vouchers_url, params: { voucher: { voucher_code: @voucher.voucher_code, voucher_type: @voucher.voucher_type, voucher_value: @voucher.voucher_value, voucher_value_remaining: @voucher.voucher_value_remaining } }
    end
  ...
  test "should update voucher" do
    patch voucher_url(@voucher), params: { voucher: { voucher_code: @voucher.voucher_code, voucher_type: @voucher.voucher_type, voucher_value: @voucher.voucher_value, voucher_value_remaining: @voucher.voucher_value_remaining } }
